...
const addIcon = `<svg style="transform:translateY(25%);" width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const installIcon = `<svg style="transform:translateY(20%);" width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const dotsMenu = `<svg style="transform:translateY(25%);" width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const linesMenu = `<svg style="transform:translateY(25%);" width="1.25rem" height="1.25rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const iosInstruc = 
  [
    "Tap "+shareIcon+" share button in the screen",
    "Tap "+addIcon+" Add to Home Screen",
  ];

const desktopInstruc = [
  "Click "+installIcon+" inside the search bar or",
  "Click the "+dotsMenu+" menu in the corner then",
  "Click "+installIcon+" install"
];
const androidInstruc = [
    "Click the "+dotsMenu+" menu in the corner",
    "Click "+installIcon+" install"
];



export const osInstruc = {
  "mac/windows/linux" : desktopInstruc,
  "android" : androidInstruc,
  "ios" : iosInstruc,
}

export const instrucs = {
  ...
  "chrome": {
    ...
    "safari": {
      "mac": [
          ...
          "Follow on-screen prompts to add to the dock"
        ],
      "iOS":  iosInstruc
    },
      ...
      "microsoft edge": {
        ...
        "firefox": {
          "windows/mac/linux": [
              "Click "+linesMenu+" menu in the corner",
              "Select "+installIcon+" Install",
            ],
            "android":  androidInstruc,
            "iOS": iosInstruc,
        },
